...
public class DroneController {
    ...
    public ResponseEntity<Drone> create(@RequestBody Drone drone) {
        if (idIsNotNull(drone)) // If the new drone has an id, there should be an error, because the id is autogenerated
    ...
    public ResponseEntity<Drone> update(@RequestBody Drone drone, @PathVariable Long id) {
        ...
        drone.setId(id); // Updating id in drone from parameter
    ...
    private boolean idIsNotNull(Drone drone) {
